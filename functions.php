...
function _scripts()
{
  ...
  wp_enqueue_style('scm_beautiful-style', get_stylesheet_uri());
  // Load font awesome css
  wp_enqueue_style('scm_beautiful-font-awesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.6.1/css/font-awesome.min.css');
  // Load minified bundle js
  wp_enqueue_script('scm_beautiful-script', get_template_directory_uri() . '/assets/script/bundle.min.js', array('jquery'), '', true);
  // Load navigation json_decode(json)
  wp_enqueue_script('scm_beautiful-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true);
  ...
  wp_enqueue_script('scm_beautiful-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true);
  // Helps td to judge whether padding needs to be added or not depending on a tag inside of td.
  wp_enqueue_script('scm_beautiful-td-padding', get_template_directory_uri() . '/src/js/td-padding.js', array(), '20120206', true);
